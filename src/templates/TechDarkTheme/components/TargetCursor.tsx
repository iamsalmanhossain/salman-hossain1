...
const TargetCursor: React.FC<TargetCursorProps> = ({
  targetSelector = '.cursor-target, button, a, input, select, textarea, [role="button"], [tabindex="0"]',
  spinDuration = 2,
  ...
  useEffect(() => {
    ...
    if (hideDefaultCursor) {
      ...
      // Also apply none to all elements to prevent flicker when hovering over native cursors
